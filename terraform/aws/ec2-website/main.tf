...
module "ec2" {
  source = "github.com/inflection-templates/devops-templates/terraform/modules/aws/ec2"
  # source = "../../../../../../../../templates/devops-templates/terraform/modules/aws/ec2"
...
module "eip" {
  source = "github.com/inflection-templates/devops-templates/terraform/modules/aws/eip"
